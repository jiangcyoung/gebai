...
| 分辨率 | 480×270 仍有 38ms（“与像素无关”） | 截帧：1080p 66ms → 540p 33ms → 270p 32.8ms（**33ms 固定 + 像素项**）；整片：540p 比 1080p 快 **1.47×**，但**仅限 remotion 通道**——浏览器通道只有 1.04×（抓帧 3.2ms/帧） | ⚠ 修正为“固定+线性”，且按通道分治 |
