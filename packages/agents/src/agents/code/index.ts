...
export const systemPrompt =
  ...
  "- CODE_PROJECT：默认项目根绑定——未指定 project 时以该项目根为基准（子会话运行形态）；\n" +
